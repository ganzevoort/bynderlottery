        ...
        <div className="space-y-6">
            <div className="text-center">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                    Browse available lottery draws and assign your ballots to participate.
                    Each draw has multiple prize categories with different winning chances.
                </p>
            </div>
            ...
            {draws.length === 0 ? (
                <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">No Open Draws</h3>
                    <p className="text-gray-600 mb-6">
                        There are currently no open draws available. Check back later for new opportunities!
                    </p>
                    <Link
                        href="/draws/closed"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {draws.map((draw) => (
                        <div key={draw.id} data-testid="draw-card" className="card card-hover overflow-hidden">
                            <div data-testid="draw-id" style={{ display: 'none' }}>{draw.id}</div>
                            <div className="p-6">
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-lg font-semibold text-gray-900">{draw.drawtype.name}</h3>
                                ...
                                <div className="space-y-2 mb-6">
                                    <h4 className="text-sm font-medium text-gray-900">Prize Categories:</h4>
