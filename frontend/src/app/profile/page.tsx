...
import { ProfileForm, ApiErrorResponse } from '@/lib/types';
    ...
    <div className="max-w-2xl mx-auto space-y-6">
              ...
              <input
                {...register('bankaccount', {
                  maxLength: {
                    value: 20,
                    message:
                      'Bank account number must be 20 characters or less',
                  },
                })}
                id="bankaccount"
                type="text"
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <p className="text-sm text-blue-700">
          ...
          For password changes, please use the &quot;Forgot Password&quot;
